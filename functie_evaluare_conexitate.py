...
def conex(comunitate):
    ...
    #parcurgem comunitatea si utilizam un vector vizitat initializat cu 0,daca avem vreun nod care nu a fost vizitata macar o data,inseamna ca acesta este izolat
    gasit = 1
    n = len(comunitate)
